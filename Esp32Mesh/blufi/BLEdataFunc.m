...
//获取蓝牙广播中的序列号
+(NSData *)GetSerialNumber:(NSDictionary *)advertisementData
{
...
//        return nil;
//    }
    NSData *serialnumberData=[ManufacturerData subdataWithRange:NSMakeRange(0, 6)];
    //NSString *serialnumber=[[NSString alloc]initWithData:serialnumberData encoding:NSASCIIStringEncoding];
    //zwjLog(@"serialnumberData = %@,%@",serialnumber,ManufacturerData);
